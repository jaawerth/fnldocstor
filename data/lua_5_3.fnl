      ...
      :fields {
          ...
          :fields {
            ...
            :isyieldable {
              ...
              :meta {
                ...
                :fnl/arglist {}
                :fnl/docstring "Returns true when the running coroutine can yield.\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-coroutine.isyieldable\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
          ...
          :fields {
            ...
            :getregistry {
              ...
              :meta {
                ...
                :fnl/arglist {}
                :fnl/docstring "Returns the registry table (see §4.5).\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-debug.getregistry\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
          ...
          :fields {
            ...
            :flush {
              ...
              :meta {
                ...
                :fnl/arglist {}
                :fnl/docstring "Equivalent to io.output():flush().\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-io.flush\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
              :path ["_G" "io" "flush"]
            }
            :input {
            ...
            :read {
              ...
              :meta {
                ...
                :fnl/arglist ["···"]
                :fnl/docstring "Equivalent to io.input():read(···).\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-io.read\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
              :path ["_G" "io" "read"]
            }
            :tmpfile {
            ...
            :write {
              ...
              :meta {
                ...
                :fnl/arglist ["···"]
                :fnl/docstring "Equivalent to io.output():write(···).\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-io.write\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
              :path ["_G" "io" "write"]
            }
          }
        ...
        :load {
          ...
          :meta {
            ...
            :fnl/docstring "Loads a chunk.\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-load\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
          }
          :path ["_G" "load"]
        }
        :loadfile {
          ...
          :fields {
            :abs {
              ...
              :meta {
                ...
                :fnl/arglist ["x"]
                :fnl/docstring "Returns the absolute value of x. (integer/float)\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-math.abs\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
              :path ["_G" "math" "abs"]
            }
            :acos {
              ...
              :meta {
                ...
                :fnl/arglist ["x"]
                :fnl/docstring "Returns the arc cosine of x (in radians).\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-math.acos\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
              :path ["_G" "math" "acos"]
            }
            :asin {
              ...
              :meta {
                ...
                :fnl/arglist ["x"]
                :fnl/docstring "Returns the arc sine of x (in radians).\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-math.asin\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
              :path ["_G" "math" "asin"]
            }
            :atan {
            ...
            :deg {
              ...
              :meta {
                ...
                :fnl/arglist ["x"]
                :fnl/docstring "Converts the angle x from radians to degrees.\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-math.deg\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
              :path ["_G" "math" "deg"]
            }
            :exp {
            ...
            :rad {
              ...
              :meta {
                ...
                :fnl/arglist ["x"]
                :fnl/docstring "Converts the angle x from degrees to radians.\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-math.rad\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
              :path ["_G" "math" "rad"]
            }
            :random {
            ...
            :sin {
              ...
              :meta {
                ...
                :fnl/arglist ["x"]
                :fnl/docstring "Returns the sine of x (assumed to be in radians).\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-math.sin\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
              :path ["_G" "math" "sin"]
            }
            :sqrt {
          ...
          :fields {
            ...
            :searchpath {
              ...
              :meta {
                ...
                :fnl/docstring "Searches for the given name in the given path.\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-package.searchpath\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
          ...
          :fields {
            ...
            :reverse {
              ...
              :meta {
                ...
                :fnl/arglist ["s"]
                :fnl/docstring "Returns a string that is the string s reversed.\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-string.reverse\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
          ...
          :fields {
            ...
            :codes {
              ...
              :meta {
                ...
                :fnl/arglist ["s"]
                :fnl/docstring "Returns values so that the construction\n----\nSource: https://www.lua.org/manual/5.3/manual.html#pdf-utf8.codes\nNOTE: These docs were scraped; for any inaccuracies, please file an issue\n      at https://github.com/jaawerth/fnldocstor/issues"
              }
              :path ["_G" "utf8" "codes"]
            }
            :len {
